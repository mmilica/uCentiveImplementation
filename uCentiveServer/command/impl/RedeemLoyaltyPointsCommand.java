...
public class RedeemLoyaltyPointsCommand extends AbstractCommand {
    ...
    public final static String COMMANDWORD = "redeemLoyaltyPoints";
    private String sessionID;

    public RedeemLoyaltyPointsCommand(String sessionID, ProofSpec spec) {
        this.spec = spec;
        this.sessionID = sessionID;
    }

    public RedeemLoyaltyPointsCommand(String sessionID, Object[] arguments) {
        this(sessionID, (ProofSpec) PrimanParser.getInstance()
                .parse((String) arguments[0]) );
    }
    ...
    public void execute() {
        ...
        try {
            ucsServer.redeemLoyaltyPointsSingleProofNonce(getConnection(), spec);
            getConnection().close();
    ...
    public String getCommandWord() {
        return RedeemLoyaltyPointsCommand.COMMANDWORD;
    }
}
